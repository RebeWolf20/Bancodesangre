...
public class daoDatosPacientes {
    ...
    String tabla = "create table if not exists contacto(id integer primary key autoincrement, rut text, nombre text, fecha text, email text, telefono text, genero text, sangre text)";
